...
class UserInterface:
    ...
    def play(self, player, computer):
        ...
        print("Dog, Exercise, Intelligence, Friendliness, Drool")
        print(" ".join(player_deck[0]))
        while True:
            try:
...
player_deck, computer_deck = run_game.make_decks()
run_game.play(player_deck, computer_deck)
